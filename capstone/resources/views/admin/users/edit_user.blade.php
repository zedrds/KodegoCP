...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script>
    <div class="page-content">
        ...
        <form method="post" id="myForm" action="{{ route('update.user') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <img id="showImage" class="rounded-circle border mt-3 avatar-xl" src="{{ (!empty($user->profile_pic)) ? url($user->profile_pic) : url('upload/default.jpg') }}" alt="Card image cap">
                            ...
                            <h4 class="card-title mt-3">Member since: <strong>{{ Carbon\Carbon::parse($user->created_at)->format('d M Y')}}</strong></h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                        ...
                        <h3 class="mb-3"><strong>Edit Profile</strong></h3>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 validate">
                                                ...
                                                <div class="col">
                                                    <input class="form-control" type="text" name="first_name" value="{{$user->first_name}}" placeholder="Enter your first name" >
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label  class="col col-form-label">Last name</label>
                                                <div class="col-sm">
                                                    <input class="form-control" type="text" name="last_name" value="{{$user->last_name}}" placeholder="Enter your last name" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="col">
                                                    <input class="form-control" type="text" name="email" value="{{$user->email}}" placeholder="Enter your email" >
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6 validate">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="col">
                                                    <input class="form-control" type="text" name="address" value="{{$user->address}}" placeholder="Your street name and house/apartment number" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="col">
                                                    <input class="form-control" type="text" name="city" placeholder="Enter town/city" value="{{$user->city}}" >
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label  class="col col-form-label">Zip code</label>
                                                <div class="col-sm">
                                                    <input class="form-control" type="text" name="zip" placeholder="Enter zip code"   value="{{$user->zip}}" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
