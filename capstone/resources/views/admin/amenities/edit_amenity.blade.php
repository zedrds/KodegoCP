...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script>
    <div class="page-content">
        ...
        <form method="post" id="myForm" action="{{ route('update.amenity') }}" enctype="multipart/form-data">
            @csrf
        <input type="hidden" name="id" value="{{$amenity->id}}"/>
            <div class="row">
                ...
                <div class="col-12 col-md-5 order-2 order-md-1">
                    <div class="card">
                    <img id="showImage"  class="card-img-top img-fluid"  src="{{ asset($amenity->amenity_image) }}" alt="Card image cap">
                ...
                <div class="col-12 col-md-5 order-1 order-md-2">
                        <div class="card">
                                    <h5 class="card-header">Update amenity</h5>
                                    <div class="card-body">
                                        <h5 class="card-title">Amenity name</h5>
                                        <input class="form-control mb-3" value="{{$amenity->amenity_name}}" name="amenity_name" type="text" >
